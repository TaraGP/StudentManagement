...
//builder.Services.Configure<IStudentStoreDatabaseSettings>(builder.Configuration.GetSection(nameof(StudetnStoreDatabaseSettings)));

builder.Services.Configure<StudentStoreDatabaseSettings>(builder.Configuration.GetSection("StudentStoreDatabaseSettings"));
//builder.Services.AddSingleton<StudentStoreDatabaseSettings>(sp => sp.GetRequiredService<IOptions<StudentStoreDatabaseSettings>>().Value);
